"""
Django settings for ifta_filing_django_api project.
...
# SECRET_KEY = 'django-insecure-*qd852wjlcl2+kt67=gphoysfm#=h+(_q5e_wk)54=5r(uoi7%'
...
ROOT_URLCONF = 'ifta_filing_django_api.urls'
...
WSGI_APPLICATION = 'ifta_filing_django_api.wsgi.application'
...
AUTH_USER_MODEL='user_account_app.User'
